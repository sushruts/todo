...
(function() {
    ...
    function TcChartjsLine2(TcChartjsFactory) {
        return new TcChartjsFactory("line2");
    }
    TcChartjsLine2.$inject = ["TcChartjsFactory"];
